...
function plaza_wordpress_scripts() {  
  wp_register_script('plaza_wordpress_js', plugins_url( '/plaza-wordpress/scripts/plaza_wordpress.js'));   
...
function plaza_wordpress_styles() {  
  wp_register_style('plaza_wordpress_style', plugins_url( '/plaza-wordpress/scripts/plaza_wordpress.css'));   
